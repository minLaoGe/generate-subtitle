...
object_subtitle = "中文"
# openAI_key
openai_key = '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'
# 原文本翻译路径
...
language = 'Japanese'
# 本地视频路径
local_vedio_path = "/Users/minfengyu/Movies/Mac Video Library/YOASOBI「祝福」Official Music Video (『機動戦士ガンダム 水星の魔女』オープニングテーマ).mp4"
# 模型的名字
model_type = 'large'
...
# 调用函数
transcribe_audio_file(local_vedio_path)
